...
import com.isoterik.android.mybaby.adapters.ContractionTimerAdapter;
...
public class ContractionTimerActivity extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ContractionTimerAdapter pregnancyTrackerAdapter = new ContractionTimerAdapter(this, getSupportFragmentManager());
